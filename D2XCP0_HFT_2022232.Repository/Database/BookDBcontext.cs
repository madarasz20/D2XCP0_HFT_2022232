...
namespace D2XCP0_HFT_2022232.Repository
{
    public class BookDBcontext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new Book("1#Harry Potter and the Sorcerer's Stone#1#9#3300#4,8#400"),
                new Book("2#Pride and Prejudice#2#1#4265#5,0#200"),
                new Book("3#The Adventures of Huckleberry Finn#3#8#2350#4,2#256"),
                new Book("4#Metamorphosis#9#6#1435#4,7#270"),
                new Book("5#The Outsider#4#7#3400#4,3#143"),
                new Book("6#The Shining#4#7#4300#4.5#177"),
                new Book("7#The Old Man and the Sea#8#9#3765#4,2#300"),
                new Book("8#Beloved#6#4#4441#4,1#123"),
